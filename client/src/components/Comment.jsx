  ...
  return (
    <div className="flex p-4 border-b dark:border-gray-600 text-sm">
      <div className="flex-shrink-0 mr-3">
        <img className="w-10 h-10 rounded-full bg-gray-200" src={user.profilePicture} alt={user.name} />
      </div>
        ...
        </div>
        {
         ...
         <>
            ...
            <div className='flex justify-end gap-2 text-xs'>
              ...
              <Button onClick={()=>setIsEditing(false)} outline type='button' size='sm' gradientDuoTone='purpleToBlue'>
                Cancel
              </Button>
